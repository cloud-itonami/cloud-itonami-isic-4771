...
- `test/apparelops/governor_test.clj` -- unit tests of governor hard
  checks, scope exclusion, and the self-trip regression test
- `test/apparelops/advisor_test.clj` -- advisor proposal shape and
  consistency
- `test/apparelops/phase_test.clj` -- rollout phase logic
- `test/apparelops/governor_contract_test.clj` -- full graph
  integration, audit trail
- `test/apparelops/store_contract_test.clj` -- Store protocol and
