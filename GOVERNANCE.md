...
`cloud-itonami-isic-4771` is an OSS open-business blueprint for
apparel/footwear/leather-goods retail operations coordination (ISIC
Rev.5 4771 -- retail sale of clothing, footwear and leather articles in
specialized stores).
...
- the ApparelRetailGovernor remains independent of the advisor.
